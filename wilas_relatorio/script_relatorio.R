...
Pop_sex <- read_excel("D:/wilas_relatorio/tabelas/Tabela 1 - Total da populacao por sexo em Aracaju.xlsx")
...
Rmed <- read_excel("D:/wilas_relatorio/tabelas/Tabela 1.1 - Renda Media Trimestral em Aracaju na Capital.xlsx")
...
PEA_NPEA <- read_excel("D:/wilas_relatorio/tabelas/Tabela 2 - População na Força e Fora da Força de Trabalho na Capital.xlsx")
PEA_NPEA <- as.data.frame(PEA_NPEA)
PEA_NPEA[,1] <- NULL
PEA_NPEA

# importar "Total de pessoas ocupadas e desocupadas na Capital.xlsx"
Tocupdes <- read_excel("D:/wilas_relatorio/tabelas/Tabela 2.1 - Total de pessoas ocupadas e desocupadas na Capital.xlsx")
Tocupdes <- as.data.frame(Tocupdes)
Tocupdes[,1] <- NULL
Tocupdes

# importar Total de Pessoas Desalentadas na Capital
T_desalento <- read_excel("D:/wilas_relatorio/tabelas/Tabela 2.2 - Total de Pessoas Desalentadas na Capital.xlsx")
...
T_estDes <- read_excel("D:/wilas_relatorio/tabelas/Tabela 3 - Pessoas ocupadas e desocupadas que estudam e nao estudam em Aracaju.xlsx")
...
(desocupfaixa <- read_excel("D:/wilas_relatorio/tabelas/Tabela 4 - Ocupacao e desocupacao por faixa etaria em Aracaju.xlsx"))
...
esc_des_faAJ <- read_excel("D:/wilas_relatorio/tabelas/Tabela 5 - Jovem desocupado e ocupado por escolaridade, Desocupado em Aracaju.xlsx")
...
nem_nem_fa_des <- read_excel("D:/wilas_relatorio/tabelas/Tabela 5.1 - Jovens nem-nem por escolaridade, Desocupado em Aracaju.xlsx")
...
Instr <- read_excel("D:/wilas_relatorio/tabelas/Tabela 6 - Total de Pessoas por Nivel de Instrucao em Aracaju.xlsx")
...
ins_n_est <- read_excel("D:/wilas_relatorio/tabelas/Tabela 7 - Nivel de instrucao das pessoas que nao estudam em Aracaju.xlsx")
...
T_nem_nem <- read_excel("D:/wilas_relatorio/tabelas/Tabela 8 - Nem estudam e nem trabalham por nivel de escolaridade em Aracaju.xlsx")
...
OcupsetorAJ <- read_excel("D:/wilas_relatorio/tabelas/Tabela 9 - Pessoas ocupadas por setor produtivo, Capital.xlsx")
...
Rmed_Setor <- read_excel("D:/wilas_relatorio/tabelas/Renda Media por Setor Trimestral em Aracaju.xlsx")
...
T_estuda <- read_excel("D:/wilas_relatorio/tabelas/Tabela 10 - Pessoas que estudam em Aracaju.xlsx")
...
txocupdes <- read_excel("D:/wilas_relatorio/tabelas/Taxa de ocupacao e desocupacao na Capital.xlsx")
